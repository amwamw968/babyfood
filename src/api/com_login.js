...
export const get_rawdata = {userinfoRaw}
  ...
  async login(event) {
    ...
    try {
      ...
      if (event.detail.errMsg === 'getUserInfo:ok'){
        ...
        userinfoRaw.userInfo = event.detail.userInfo
    ...
    let userinfo = {}
      ...
      userinfo = await wepy.request({
        ...
        dataType: 'json',
        data: { name: userinfoRaw.userInfo.nickName,  password: userinfoRaw.userInfo.nickName}
      })
